...
ssh-keygen -t rsa
# Enter 3 times to skip naming the directory and setting up the passphrase
# rsa - initials of the 3 people
# cd into .ssh folder
# Copy the public key in id_rsa.pub and add it to ssh key in Digital Ocean
# Create a droplet on Digital Ocean using this key
...
# Continue even though authenticity can't be established
yes
